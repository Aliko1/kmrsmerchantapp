...
/*		htm+='<ons-col width="25%" class="center" >';
		...
		htm+='<ons-col class="first_text" >';
		   ...
		   htm+='<p class="margin2 small-font-dim small-font-dim-smaller">'+ getTrans("Order Number",'order_no') +'. <b>'+val.order_id+'</b></p>';
		   htm+='<p class="margin2 small-font-dim small-font-dim-smaller">Order Time: '+val.date_created+'</p>';
		 ...
		 htm+='</ons-col>';
 htm+='<ons-col width="25%" class="text-middle" >';
		   htm+='<price>Total: '+val.total_w_tax_prety+'</price>';
 htm+='</ons-col>';
...
function displayOrderDetails(data)
{
	...
	var html='<ons-list-header class="header">';
        html+='<ons-row>';
        html+='<p style="text-align:center;"><ons-col><ons-icon icon="'+icons.icons+'" class="icon '+icons.classname+'"></ons-icon> Delivery Time: '+data.del_time+'</ons-col></p>';
        html+='<p><ons-col class="text-left"> Status: '+data.status+'</ons-col><ons-col class="text-right"> Order No: '+data.order_id+'</ons-col></p>';
        html+='</ons-row>';
